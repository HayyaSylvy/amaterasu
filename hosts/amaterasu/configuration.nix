...

{
  ...
  boot.initrd.luks.devices."luks-8a5aa243-100c-462c-9b5a-031c5fd779cb".device = "/dev/disk/by-uuid/8a5aa243-100c-462c-9b5a-031c5fd779cb";
  ...
  stylix = {
     ...
     image = ./../../modules/home-manager/assets/gruvyy.png;
     polarity = "dark";
